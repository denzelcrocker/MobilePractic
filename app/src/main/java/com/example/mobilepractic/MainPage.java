...
public class MainPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterQuote = new AdapterQuote(MainPage.this, qList);
        ...
        adapterFeeling = new AdapterFeeling(fList,MainPage.this);
        Mood.setAdapter(adapterFeeling);


        greeting = findViewById(R.id.Greeting);
        greeting.setText("С возвращением, "+ Autorization.users.getNickName() + "!");
        Avatar=findViewById(R.id.Avatar);
        new DownloadImageTask((ImageView) Avatar).execute(Autorization.users.getAvatar());
    ...
    private class GetQuote extends AsyncTask<Void,Void,String>
    {
        ...
        protected void onPostExecute(String s) {
            ...
            {
                Toast.makeText(MainPage.this, "При выводе данных возникла ошибка", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public void List(View v) {
        Intent intent = new Intent(MainPage.this, Listener.class);
